...
for file in csv_files:
    try:
        ...
        # 檢查是否為 90 維的滑動窗口資料，如果是，僅篩選出最新的一幀 (t4) 作為「原始單幀」數據
...
print(f"原始單幀數據打包完成（特徵數：{X_train.shape[1]} 維）。訓練集計: {len(train_dataset)} 筆，測試集計: {len(test_dataset)} 筆。")
...
# 5. 匯出最好的模型
model_filename = "trainModel2/radar_model.pkl"
